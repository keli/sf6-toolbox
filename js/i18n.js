export const STRINGS = {
  en: {
    tab_meaty: "Frame Kill Calculator",
    ...
    note_delay: "⚠ Delayed frame-kill routes are theoretical values only.",
    chk_safe_only: "Safe Only (On Block ≥ −3)",
    chk_cancel_only: "Cancelable Moves Only",
    chk_no_sp_kd: "Exclude Cancelable Knockdown Sources",
    chk_first_any: "Allow Normals as Prefix",
    chk_include_dr_first: "Allow Drive Rush as Prefix",
    chk_effective_only: "Effective Frame-Kill Only",
    ...
    status_result: (char, n) => `${char}: ${n} frame-kill routes found`,
    no_results: "No frame-kill routes found for the current filters.",
    th_sequence: "Sequence",
    th_startup: "Startup",
    th_active: "Active Frames",
    th_hit_frame: "Hit Frame",
    th_stolen: "Stolen Frames",
    th_on_hit: "On Hit",
    ...
    tip_none: "None",
    tip_can_delay: (n) =>
      `Delaying ${n}f may reach the optimal hit frame (some moves lose active frames when not done ASAP, so actual frame advantage may be worse)`,
    kd_label: "KD",
    hkd_label: "HKD",
